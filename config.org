...
** Theme & Fonts
#+begin_src emacs-lisp
  ;;(set-face-attribute 'default nil :font "Iosevka Aile Medium" :height 110)
  ;;(set-face-attribute 'fixed-pitch nil :font "Iosevka Aile Medium" :height 110)
  ;;(set-face-attribute 'fixed-pitch nil :font "Blex Mono Nerd Font" :height 110)
  
  ;;(add-to-list 'default-frame-alist '(font . "Iosevka Nerd Font Mono")) ;; this kinda works
...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (set-face-attribute 'org-block nil :foreground nil :font "Iosevka Aile Medium" :height 110) ;; TODO not working, probably not the correct approach
