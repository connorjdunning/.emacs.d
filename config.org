...
1. Delete the bundled org-mode package to make room for the newest version.
2. eval the *Straight.el* block
3. eval the *Org-mode* block, or at least *Literate Programming*
4. ensure 'early-init.el' is present *BEFORE* you next start emacs. It should have been created, if not copy the code from the /early-init.el/ block.
